...
\noindent 围绕\textbf{长程大语言模型智能体}开展研究，从\textbf{算法}、\textbf{评测}与\textbf{系统}三个层面推进可靠自主系统：一方面研究多轮优化与上下文折叠算法，另一方面构建智能体认知能力评测框架，并进一步探索面向真实场景的可控长程运行系统。
\vspace{0.8em}

% Experience Section
\section*{\color{sectioncolor}实习经历}
    \subsubsection*{\color{itemcolor}字节跳动｜算法实习生（长程 Agent 系统）}
    ...
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
        \item 端到端负责长程 Agent 系统的设计与落地，面向复杂任务中的持续执行、自迭代优化与人工介入需求。
        \item 构建统一框架，将持续运行、过程评估与迭代优化闭环联结起来，支撑长时程智能体行为的稳定执行。
        \item 支持 \textbf{Auto / Interactive / Human-Interrupt} 三种运行模式，提升系统在自主执行与人机协同场景下的可控性。
        \item 建立异常恢复与人工接管机制，增强系统在长时程运行中的鲁棒性与可靠性。
    \end{itemize}
\vspace{0.8em}
...
\section*{\color{sectioncolor}代表性研究成果}
    ...
    \subsubsection*{1.\color{itemcolor}FoldAct：面向智能体多轮交互的上下文折叠算法}
    ...
    \skills{\skilltag{基准设计} \skilltag{评估方法论} \skilltag{研究领导力}} 
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
        \item 开发 \textbf{SeekBench} 标准化评测基准，用于系统评估搜索型大语言模型智能体的认知能力，而不仅仅停留在最终任务准确率层面。
        \item 提出并落地轨迹级评测范式，刻画智能体在搜索过程中对证据的获取、修正与校准行为。
    ...
    \noindent\textbf{\color{sectioncolor}研究指导}  \hfill \color{accentcolor}\textbf{2025年2月 – 至今} \\
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
        \item 搭建学生科研推进机制，覆盖选题设计、系统实现、实验组织与论文写作，并指导 \textbf{10余名本科生} 开展大语言模型叙事系统、记忆机制与人机协作相关研究。
        \item 组织与 Duke 相关合作伙伴的交流展示活动，包括项目汇报与论坛展出，推动跨机构沟通协作与团队协调。
    \end{itemize}
    \vspace{0.5em}
