...
\section*{\color{sectioncolor}实习经历}
    ...
    \noindent\textbf{\color{sectioncolor}Agent4Research Harness 与 Harness Eval 研究} \hfill \color{accentcolor}\textbf{2026年5月 – 至今}
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
        \item 开展 \textbf{Agent4Research Harness} 研究，构建面向研究型大语言模型智能体的可扩展执行与评测基础设施。
        \item 开展 \textbf{Harness Eval} 评测研究，建立长程智能体能力的严格评测方法与基准。
    \end{itemize}
