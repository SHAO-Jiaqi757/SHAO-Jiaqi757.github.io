...
\section*{\color{sectioncolor}代表性研究成果}
    ...
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
        \item 提出 \textbf{FoldAct} 上下文折叠优化框架，直击长程搜索智能体多轮强化学习中由摘要策略非平稳引发的训练不稳定问题。
        \item 设计结构化折叠训练流程，在控制上下文长度的同时提升折叠策略学习的稳定性与训练效率。
        \item 在复杂搜索智能体任务上实现最高 \textbf{5.19倍} 训练加速，并保持长程决策质量，验证该方法在长程智能体优化中的可扩展性与实用性。
    \end{itemize}
    ...
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
        \item 从零主导 \textbf{MASArena} 开源评测框架的架构设计与实现，统一单智能体与多智能体系统的实验编排、结果管理与可视化分析流程。
