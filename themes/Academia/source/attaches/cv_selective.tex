...
\section*{\color{sectioncolor}Representative Research}
    ...
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
        \item Proposed \textbf{FoldAct}, a context-folding optimization framework for long-horizon LLM agents that directly addresses instability caused by non-stationary summarization policies in multi-turn RL.
        \item Designed a structured folding-training pipeline that stabilizes summary-policy learning while improving optimization efficiency under long-context constraints.
    ...
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
        \item Led the architecture and implementation of \textbf{MASArena}, an open-source benchmarking stack that unifies experiment orchestration, result management, and visual analytics across single-agent and multi-agent systems.
        \item Built reusable, extensible evaluation infrastructure for standardized comparison across agents, tools, and datasets, strengthening reproducibility and interpretability. \href{https://github.com/LINs-lab/MASArena/graphs/contributors}{\color{linkcolor}[Code contributions]}
    \end{itemize}
