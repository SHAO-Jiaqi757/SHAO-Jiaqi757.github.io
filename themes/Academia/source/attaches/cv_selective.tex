...
\newcommand{\myInterests}{Long-horizon LLM Agents \textbar{} Agent Evaluation \textbar{} Reliable Autonomous Systems}
...
\noindent Developing \textbf{long-horizon LLM agents} from three complementary perspectives: \textbf{algorithms} for stable multi-turn optimization, \textbf{evaluation} for epistemic competence and reliability, and \textbf{systems} for controllable autonomous execution in real-world settings.
\vspace{0.8em}
...
\section*{\color{sectioncolor}Experience}
    ...
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
        ...
        \item Established recovery and handoff mechanisms for failures and intervention, improving robustness and reliability in extended runs.
    \end{itemize}
\vspace{0.8em}
...
\section*{\color{sectioncolor}Representative Research}
    ...
    \subsubsection*{\color{itemcolor}FoldAct: FoldAct: Efficient and Stable Context Folding for Long-Horizon Search Agents}
    \noindent\textbf{\color{sectioncolor}Lead} | Algorithm Design \hfill \color{accentcolor}\textbf{arXiv preprint, 2025} \\
    ...
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
        ...
        \item Achieved up to \textbf{5.19$\times$} training speedup on complex search-agent tasks while maintaining strong long-horizon decision quality.
    \end{itemize}
    \vspace{0.5em}
    \subsubsection*{\color{itemcolor}SeekBench: Benchmarking Epistemic Competence in LLM Search Agents}
    \noindent\textbf{\color{sectioncolor}Lead} | Benchmark Design \& Evaluation Methodology \hfill \color{accentcolor}\textbf{ICLR 2026 (Accepted)} \\
    ...
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
        \item Designed a decentralized collaboration framework in which LLM agents dynamically evolve roles without predefined structures.
    ...
    \noindent\textbf{\color{sectioncolor}Research Mentor} \hfill \color{accentcolor}\textbf{Feb. 2025 – Present} \\
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
...
\section*{\color{sectioncolor}Supporting Projects}
    \subsubsection*{\color{itemcolor}FedKit: Cross-Platform Federated Learning for Android and iOS}
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
        \item Developed a cross-platform federated learning pipeline covering model conversion, hardware-accelerated training, and on-device aggregation; accepted at \textbf{IEEE INFOCOM 2024 Demo}.
    \end{itemize}
    \vspace{0.4em}
    \subsubsection*{\color{itemcolor}FedCampus: Privacy-preserving Mobile Application for Smart Campus}
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
        \item Built a real-world mobile application integrating federated learning and differential privacy, with deployment to \textbf{100} customized smart watches and Android/iOS clients.
    \end{itemize}
\vspace{0.8em}
