...
\section*{\color{sectioncolor}Experience}
    ...
    \noindent\textbf{\color{sectioncolor}Agent4Research Harness \& Harness Eval} \hfill \color{accentcolor}\textbf{May 2026 -- Present}
    \begin{itemize}[leftmargin=*, label=\textcolor{accentcolor}{\textbullet}, itemsep=0.2em]
        \item Research on agent4research harness to build scalable evaluation and execution infrastructure for LLM-driven research agents.
        \item Research on harness eval to develop rigorous evaluation methodologies and benchmarks for long-horizon agent capabilities.
    \end{itemize}
